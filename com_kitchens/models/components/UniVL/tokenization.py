    ...
    def convert_tokens_to_ids(self, tokens):
        ...
        for token in tokens:
            if token not in self.vocab:
                ...
                logger.error(f"Cannot find token '{token}' in vocab. Using [UNK] insetad")
            else:
    ...
    def from_pretrained(cls, pretrained_model_name, cache_dir=None, *inputs, **kwargs):
        ...
        try:
            ...
            logger.error(
                ...
                "associated to this path or url.".format(pretrained_model_name, vocab_file)
            )
            return None
