...
from com_kitchens.models.components.xclip.modeling import CLIP4Clip
from com_kitchens.models.components.xclip.optimization import BertAdam

logger = logging.getLogger(__name__)


class CLIP4clipLitModule(LightningModule):
    def __init__(
        self,
        cross_config,
        clip_state_dict,
    ...
    def validation_step(self, batch: Any, batch_idx: int):
        ...
        sim_loss = self.model_step(batch)
...
if __name__ == "__main__":
    ...
    with open("configs/model/clip4clip.yaml") as yml:
    ...
    _ = CLIP4clipLitModule(cross_config, clip_state_dict, task_config)
