# copied from https://github.com/openai/CLIP/blob/main/clip/simple_tokenizer.py
...
def bytes_to_unicode():
    ...
    dataset you end up needing around 5K for decent coverage. This is a signficant percentage of
