...
PRESAVE_DIR = "./singularity/vid2seq"
MODEL_DIR = "models"
DATA_DIR = "./data"
SSD_DIR = "./data"
NLTK_FOLDER = "/app/nltkc"
name2folder = {
    "youcook": "YouCook2",
    "htm": "howto100m",
...
def get_args_parser():
    ...
    # generic
    parser.add_argument("--train_json_path", default=None)
    parser.add_argument("--val_json_path", default=None)
    parser.add_argument("--test_json_path", default=None)
    parser.add_argument('--features_path', default=None)
    parser.add_argument('--subtitles_path', default=None)
    
    # com-k
    parser.add_argument('--recipes_path', default=None)
    parser.add_argument('--predict_rel_labels', action='store_true')
    parser.add_argument('--rel_labels_coeff', default=1.0, type=float)
    parser.add_argument('--use_attn_sup', action='store_true')
    parser.add_argument('--attn_sup_coeff', default=0.05, type=float)
